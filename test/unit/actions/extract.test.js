...
test.todo('actionExtract', async t => {
    var tags = { 'name': 'test' };
    ...
    it('linear way', function () {
        ...
        it('target in first position', function () {
            beforeEach(function () {
        ...
        it('target in second position', function () {
            beforeEach(function () {
    ...
    it('intersecting linear ways', function () {
        var graph;
        beforeEach(function () {
            //
            //           f
    ...
    it('intersecting closed way', function () {
        var graph;
        beforeEach(function () {
            //
            //       g == f
