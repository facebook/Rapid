...
export function coreFileFetcher() {
  ...
  let _fileMap = {
    ...
    'oci_defaults': 'https://cdn.jsdelivr.net/npm/osm-community-index@5.3/dist/defaults.min.json',
    'oci_features': 'https://cdn.jsdelivr.net/npm/osm-community-index@5.3/dist/featureCollection.min.json',
    'oci_resources': 'https://cdn.jsdelivr.net/npm/osm-community-index@5.3/dist/resources.min.json',
