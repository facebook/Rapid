...
/**
 * `BehaviorMapNudging` listens to pointer events and converts those into small map panning 'nudges' when the pointer nears the edge of the screen
 ...
 */
export class BehaviorMapNudging extends AbstractBehavior {
