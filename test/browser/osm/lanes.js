describe('Lanes', function() {
    ...
    describe('default lane tags', function() {
        ...
        describe('motorway', function() {
            ...
            it('returns 2 lanes for highway=motorway', function() {
                expect(Rapid.osmWay({tags: { highway: 'motorway' }}).lanes().metadata.count, 'motorway lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'motorway', oneway: 'yes' }}).lanes().metadata.count, 'motorway lanes')
                    .to.eql(2);
            });

            it('returns 4 lanes for highway=motorway and oneway=no', function() {
                expect(Rapid.osmWay({tags: { highway: 'motorway', oneway: 'no' }}).lanes().metadata.count, 'motorway lanes')
                    .to.eql(4);
            });

            it('returns 2 lanes for highway=motorway_link', function() {
                expect(Rapid.osmWay({tags: { highway: 'motorway_link' }}).lanes().metadata.count, 'motorway_link lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'motorway_link', oneway: 'no' }}).lanes().metadata.count, 'motorway_link lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=motorway_link and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'motorway_link', oneway: 'yes' }}).lanes().metadata.count, 'motorway_link lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('trunk', function() {
            ...
            it('returns 4 lanes for highway=trunk', function() {
                expect(Rapid.osmWay({tags: { highway: 'trunk' }}).lanes().metadata.count, 'trunk lanes')
                    .to.eql(4);
                expect(Rapid.osmWay({tags: { highway: 'trunk', oneway: 'no' }}).lanes().metadata.count, 'trunk lanes')
                    .to.eql(4);
            });

            it('returns 2 lanes for highway=trunk and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'trunk', oneway: 'yes' }}).lanes().metadata.count, 'trunk lanes')
                    .to.eql(2);
            });

            it('returns 2 lanes for highway=trunk_link', function() {
                expect(Rapid.osmWay({tags: { highway: 'trunk_link' }}).lanes().metadata.count, 'trunk_link lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'trunk_link', oneway: 'no' }}).lanes().metadata.count, 'trunk_link lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=trunk_link and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'trunk_link', oneway: 'yes' }}).lanes().metadata.count, 'trunk_link lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('primary', function() {
            ...
            it('returns 2 lanes for highway=primary', function() {
                expect(Rapid.osmWay({tags: { highway: 'primary' }}).lanes().metadata.count, 'primary lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'primary', oneway: 'no' }}).lanes().metadata.count, 'primary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=primary and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'primary', oneway: 'yes' }}).lanes().metadata.count, 'primary lanes')
                    .to.eql(1);
            });

            it('returns 2 lanes for highway=primary_link', function() {
                expect(Rapid.osmWay({tags: { highway: 'primary_link' }}).lanes().metadata.count, 'primary lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'primary_link', oneway: 'no' }}).lanes().metadata.count, 'primary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=primary_link and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'primary_link', oneway: 'yes' }}).lanes().metadata.count, 'primary lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('seconday', function() {
            ...
            it('returns 2 lanes for highway=secondary', function() {
                expect(Rapid.osmWay({tags: { highway: 'secondary' }}).lanes().metadata.count, 'secondary lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'secondary', oneway: 'no' }}).lanes().metadata.count, 'secondary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=secondary and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'secondary', oneway: 'yes' }}).lanes().metadata.count, 'secondary lanes')
                    .to.eql(1);
            });

            it('returns 2 lane for highway=secondary_link', function() {
                expect(Rapid.osmWay({tags: { highway: 'secondary_link' }}).lanes().metadata.count, 'secondary_link lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'secondary_link', oneway: 'no' }}).lanes().metadata.count, 'secondary_link lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=secondary_link and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'secondary_link', oneway: 'yes' }}).lanes().metadata.count, 'secondary_link lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('tertiary', function() {
            ...
            it('returns 2 lanes for highway=tertiary', function() {
                expect(Rapid.osmWay({tags: { highway: 'tertiary' }}).lanes().metadata.count, 'tertiary lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'tertiary', oneway: 'no' }}).lanes().metadata.count, 'tertiary lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=tertiary and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'tertiary', oneway: 'yes' }}).lanes().metadata.count, 'tertiary lanes')
                    .to.eql(1);
            });

            it('returns 2 lane for highway=tertiary_link', function() {
                expect(Rapid.osmWay({tags: { highway: 'tertiary_link' }}).lanes().metadata.count, 'tertiary_link lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'tertiary_link', oneway: 'no' }}).lanes().metadata.count, 'tertiary_link lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=tertiary_link and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'tertiary_link', oneway: 'yes' }}).lanes().metadata.count, 'tertiary_link lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('residential', function() {
            ...
            it('returns 2 lanes for highway=residential', function() {
                expect(Rapid.osmWay({tags: { highway: 'residential' }}).lanes().metadata.count, 'residential lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'residential', oneway: 'no' }}).lanes().metadata.count, 'residential lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=residential and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'residential', oneway: 'yes' }}).lanes().metadata.count, 'residential lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('service', function() {
            ...
            it('returns 2 lanes for highway=service', function() {
                expect(Rapid.osmWay({tags: { highway: 'service' }}).lanes().metadata.count, 'service lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'service', oneway: 'no' }}).lanes().metadata.count, 'service lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=service and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'service', oneway: 'yes' }}).lanes().metadata.count, 'service lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('track', function() {
            ...
            it('returns 2 lanes for highway=track', function() {
                expect(Rapid.osmWay({tags: { highway: 'track' }}).lanes().metadata.count, 'track lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'track', oneway: 'no' }}).lanes().metadata.count, 'track lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=track and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'track', oneway: 'yes' }}).lanes().metadata.count, 'track lanes')
                    .to.eql(1);
            });
        });
        ...
        describe('path', function() {
            ...
            it('returns 2 lanes for highway=path', function() {
                expect(Rapid.osmWay({tags: { highway: 'path' }}).lanes().metadata.count, 'path lanes')
                    .to.eql(2);
                expect(Rapid.osmWay({tags: { highway: 'path', oneway: 'no' }}).lanes().metadata.count, 'path lanes')
                    .to.eql(2);
            });

            it('returns 1 lane for highway=path and oneway=yes', function() {
                expect(Rapid.osmWay({tags: { highway: 'path', oneway: 'yes' }}).lanes().metadata.count, 'path lanes')
                    .to.eql(1);
            });
        });
    });
    ...
    describe('oneway tags', function() {
        it('returns correctly oneway when tagged as oneway', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', oneway: 'yes' }}).lanes().metadata.oneway, 'residential lanes')
                .to.be.true;
            expect(Rapid.osmWay({tags: { highway: 'residential', oneway: 'no' }}).lanes().metadata.oneway, 'residential lanes')
                .to.be.false;
        });
    });
    ...
    describe('lane direction', function() {
        ...
        it('returns correctly the lane:forward and lane:backward count', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1, 'lanes:backward': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 2,
                    oneway: false,
                    forward: 1,
            ...
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 4, 'lanes:forward': 3, 'lanes:backward': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 4,
                    oneway: false,
                    forward: 3,
        ...
        it('returns correctly the count if erroneous values are supplied', function() {
            expect(Rapid.osmWay({tags: { highway: 'trunk', lanes: 2, 'lanes:forward': 3 }}).lanes().metadata, 'trunk lanes')
                .to.include({
                    count: 2,
                    oneway: false,
                    forward: 2,
        ...
        it('returns correctly forward count when oneway=yes', function() {
            expect(Rapid.osmWay({tags: { highway: 'trunk', lanes: 2, oneway: 'yes' }}).lanes().metadata, 'trunk lanes')
                .to.include({
                    count: 2,
                    oneway: true,
                    forward: 2,
        ...
        it('returns correctly backward count the when oneway=-1', function() {
            expect(Rapid.osmWay({tags: { highway: 'primary', lanes: 4, oneway: '-1' }}).lanes().metadata, 'primary lanes')
                .to.include({
                    count: 4,
                    oneway: true,
                    backward: 4,
        ...
        it('skips provided lanes:forward value when oneway=yes', function() {
            expect(Rapid.osmWay({tags: { highway: 'trunk', lanes: 2, oneway: 'yes', 'lanes:forward': 1 }}).lanes().metadata, 'trunk lanes')
                .to.include({
                    count: 2,
                    oneway: true,
                    forward: 2,
        ...
        it('skips provided lanes:backward value when oneway=yes', function() {
            expect(Rapid.osmWay({tags: { highway: 'trunk', lanes: 2, oneway: 'yes', 'lanes:backward': 1 }}).lanes().metadata, 'trunk lanes')
                .to.include({
                    count: 2,
                    oneway: true,
                    forward: 2,
        ...
        it('returns correctly forward count if only backward is supplied', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 3, 'lanes:backward': 1, }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 3,
                    oneway: false,
                    forward: 2,
            ...
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 4, 'lanes:backward': 3, }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 4,
                    oneway: false,
                    forward: 1,
        ...
        it('returns correctly backward count if only forward is supplied', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 3, 'lanes:forward': 1, }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 3,
                    oneway: false,
                    forward: 1,
            ...
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1, }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 2,
                    oneway: false,
                    forward: 1,
        ...
        it('returns correctly backward count if forward and both_ways are supplied', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 3, 'lanes:forward': 1, 'lanes:both_ways': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 3,
                    oneway: false,
                    forward: 1,
            ...
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:forward': 1, 'lanes:both_ways': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 5,
                    oneway: false,
                    forward: 1,
        ...
        it('returns correctly forward count if backward and both_ways are supplied', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 3, 'lanes:backward': 1, 'lanes:both_ways': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 3,
                    oneway: false,
                    forward: 1,
            ...
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:backward': 1, 'lanes:both_ways': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 5,
                    oneway: false,
                    forward: 3,
        ...
        it('returns correctly the lane:both_ways count as 1', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1, 'lanes:both_ways': 1 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 2,
                    oneway: false,
                    forward: 1,
        ...
        it('returns correctly when lane:both_ways>1', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:forward': 2, 'lanes:both_ways': 2, 'lanes:backward': 2 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 5,
                    oneway: false,
                    forward: 2,
        ...
        it('returns correctly when lane:both_ways is 0 or Not a Number', function() {
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:forward': 2, 'lanes:both_ways': 0, 'lanes:backward': 3 }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 5,
                    oneway: false,
                    forward: 2,
            ...
            expect(Rapid.osmWay({tags: { highway: 'residential', lanes: 2, 'lanes:forward': 1, 'lanes:both_ways': 'none' }}).lanes().metadata, 'residential lanes')
                .to.include({
                    count: 2,
                    oneway: false,
                    forward: 1,
    ...
    describe.skip('lanes array', function() {
      it('should have correct number of direction elements', function() {
        var lanes = Rapid.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:forward': 2, 'lanes:both_ways': 0, 'lanes:backward': 3 }}).lanes().lanes;
      ...
      it('should have correct number of direction elements', function() {
        var lanes = Rapid.osmWay({tags: { highway: 'residential', lanes: 5, 'lanes:backward': 1, 'lanes:both_ways': 1 }}).lanes().lanes;
        var forward = lanes.filter(function(l) {
          return l.direction === 'forward';
        });
        var backward = lanes.filter(function(l) {
    ...
    describe('maxspeed:lanes', function() {
        ...
        it('should parse correctly', function() {
            var maxspeedLanes = Rapid.osmWay({
                tags: {
                    highway: 'residential',
                    lanes: 5,
