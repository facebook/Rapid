...
export function helpHtml(context, id, replacements) {
  ...
  if (!helpStringReplacements) {
    helpStringReplacements = {
      ...
      leftclick: icon('#rapid-interaction-mouse-left', 'operation'),
      rightclick: icon('#rapid-interaction-mouse-right', 'operation'),
      mousewheel_icon: icon('#rapid-interaction-mouse-wheel', 'operation'),
      tap_icon: icon('#rapid-interaction-onefinger-tap', 'operation'),
      doubletap_icon: icon('#rapid-interaction-onefinger-tap', 'operation'),
      longpress_icon: icon('#rapid-interaction-onefinger-tap-and-hold', 'operation'),
      touchdrag_icon: icon('#rapid-interaction-onefinger-tap-and-drag', 'operation'),
      twofinger_drag_icon: icon('#rapid-interaction-twofinger-tap-and-drag', 'operation'),
      pinch_icon: icon('#rapid-interaction-twofinger-pinch', 'operation'),
