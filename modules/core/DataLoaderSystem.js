...
export class DataLoaderSystem extends AbstractSystem {
  ...
  constructor(context) {
    ...
    fileMap.set('deprecated', 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.4/dist/deprecated.min.json');
    fileMap.set('discarded', 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.4/dist/discarded.min.json');
    ...
    fileMap.set('preset_categories', 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.4/dist/preset_categories.min.json');
