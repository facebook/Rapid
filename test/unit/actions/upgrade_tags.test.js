...
test('actionUpgradeTags', async t => {

    await t.test('upgrades a tag', () => {
    ...
    await t.test('upgrades a tag combination', () => {
    ...
    await t.test('upgrades a tag with multiple replacement tags', () => {
    ...
    await t.test('upgrades a tag and overrides an existing value', () => {
    ...
    await t.test('upgrades a tag with no replacement tags', () => {
    ...
    await t.test('upgrades a wildcard tag and moves the value', () => {
        const oldTags = { color: '*' };
    ...
    await t.test('upgrades a tag with a wildcard replacement and adds a default value', () => {
    ...
    await t.test('upgrades a tag with a wildcard replacement and maintains the existing value', () => {
        const oldTags = { amenity: 'shop' };
        const newTags = { shop: '*' };
    ...
    await t.test('upgrades a tag with a wildcard replacement and replaces the existing "no" value', () => {
        const oldTags = { amenity: 'shop' };
        const newTags = { shop: '*' };
    ...
    await t.test('upgrades a tag from a semicolon-delimited list that has one other value', () => {
    ...
    await t.test('upgrades a tag from a semicolon-delimited list that has many other values', () => {
        const oldTags = { cuisine: 'vegan' };
        const newTags = { 'diet:vegan': 'yes' };
    ...
    await t.test('upgrades a tag within a semicolon-delimited list without changing other values', () => {
    ...
    await t.test('upgrades an entire semicolon-delimited tag value', () => {
