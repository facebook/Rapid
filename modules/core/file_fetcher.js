...
export function coreFileFetcher() {
  ...
  let _fileMap = {
    ...
    'deprecated': 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.0/dist/deprecated.min.json',
    'discarded': 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.0/dist/discarded.min.json',
    ...
    'oci_defaults': 'https://cdn.jsdelivr.net/npm/osm-community-index@5.5/dist/defaults.min.json',
    'oci_features': 'https://cdn.jsdelivr.net/npm/osm-community-index@5.5/dist/featureCollection.min.json',
    'oci_resources': 'https://cdn.jsdelivr.net/npm/osm-community-index@5.5/dist/resources.min.json',
    'preset_categories': 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.0/dist/preset_categories.min.json',
    'preset_defaults': 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.0/dist/preset_defaults.min.json',
    'preset_fields': 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.0/dist/fields.min.json',
    'preset_presets': 'https://cdn.jsdelivr.net/npm/@openstreetmap/id-tagging-schema@6.0/dist/presets.min.json',
