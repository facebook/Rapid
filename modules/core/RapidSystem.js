  ...
  initAsync() {
    ...
    return this._initPromise = prerequisites
      .then(() => {
        ...
        this._datasets.set('rapidMapFeatures', {
          id: 'rapidMapFeatures',
          beta: false,
          ...
          service: 'mapwithai',
          color: RAPID_MAGENTA,
          label: l10n.t('rapid_feature_toggle.rapidMapillaryFeatures.label'),
          license_markdown: l10n.t('rapid_feature_toggle.rapidMapillaryFeatures.license_markdown')
        });
      });
  }
