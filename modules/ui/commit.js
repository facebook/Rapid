...
export function uiCommit(context) {
  ...
  function updateSessionChangesetTags() {
    ...
    let usedRapid = context.rapidSystem().sources;
    ...
    const warnings = context.validationSystem()
    ...
    const resolvedIssues = context.validationSystem().getResolvedIssues();
  ...
  function getUploadBlockerMessage() {
    const errors = context.validationSystem()
